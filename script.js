...
function updateBackground() {
    const images = ['clouds', 'konstanz', 'sunset', 'forest', 'mountains', 'tenerife', 'path', 'prague', 'neuschwanstein', 'castle', 'library', 'modern-architecture', 'rotterdam', 'straßburg', 'valley', 'mersaille', 'highway', 'farm', 'park']; // image names array
